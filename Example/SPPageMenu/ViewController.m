...
- (void)viewDidLoad {
    ...
    self.titles = @[@"跟踪器样式专区",@"排列方式专区",@"跟踪器跟踪模式专区",@"其余功能",@"特别属性"];
    self.dataSource = @[@[@"下划线与按钮等宽(默认)",@"下划线比按钮略长",@"下划线“依恋”样式",@"缩放",@"圆角矩形",@"圆角矩形（与pageMenu同时圆角）",@"矩形",@"无样式"],@[@"可滑动的自适应内容排列",@"不可滑动的等宽排列",@"不可滑动的自适应内容排列"],@[@"跟踪器时刻跟随外界scrollView移动",@"外界scrollVie拖动结束后，跟踪器才开始移动",@"外界scrollView拖动距离超过屏幕一半时，跟踪器开始移动"],@[@"含有图片的按钮",@"指定按钮携带图片,或同时携带图片和文字,可以设置图片的位置",@"显示右侧功能按钮",@"给功能按钮设置图片和文字"],@[@"bridgeScrollView属性"]];
}
